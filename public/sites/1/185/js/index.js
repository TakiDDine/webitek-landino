...
if (gsInput) {
	...
	form.addEventListener("submit", (e) => {
		...
		const formValidation = () => {
			...
			let checkbox = form.querySelector(".checkbox-group input[type='checkbox']")
			...
			if (checkbox) {
				if (!checkbox.checked) {
					let span = document.createElement("span")
					span.innerHTML = "please checked one value";
					if (!form.querySelector(".checkbox-group span")) {
						form.querySelector(".checkbox-group").appendChild(span)
					}
					isValid = false;
				}
			}
