import PaddingMargin from "../global/PaddingMargin";
    ...
    constructor(options) {
      ...
      super({
        ...
        callback: () => {
          ...
          if (oldVal !== '') {
            let globalMargin = Core.prototype._elementNoPx(this._properties.media[options.mediaMode][options.mode].value);
            return globalMargin;
          }
          return oldVal;
        },
