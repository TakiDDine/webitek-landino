...
class LineHeight extends HalfInput {
    constructor(options) {
      ...
      HalfInput.call(this, {
        ...
        callback: () => {
          ...
          if (oldVal !== "") {
            let globalLineHeight = Core.prototype._elementNoPx(this._properties.media[options.mediaMode][options.mode].value).split(' ')[0];
            return globalLineHeight;
          }
          return oldVal;
        },
      });
