...
(function($) {
    ...
    MAJESTY.header = {
        ...
        menufunctions: function() {
            ...
            if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
                ...
                $('#main-menu.sub-title').children('ul').children('.current').prev().css({
                    backgroundImage: 'none'
                });
                $('#main-menu.sub-title').children('div').children('ul').children('.current').prev().css({
                    backgroundImage: 'none'
                });
            }
        ...
        overlayMenu: function() {
            if ($body.hasClass('overlay-menu')) {
                ...
                $('#main-menu').children('ul').children('li:first-child').css({
        ...
        splitmenu: function() {
            if (($body.hasClass('device-lg') || $body.hasClass('device-md')) && $header.hasClass('split-menu')) {
                ...
                element.css({
                    'margin-left': -logoPosition + 'px'
                });

                $('#main-menu').find('.menu-left').css({
                    'padding-right': menuPadding + 'px'
                });
                $('#main-menu').find('.menu-right').css({
    ...
    $window.load('on', MAJESTY.documentOnLoad.init);
