    ...
    data: function (element) {
      ...
      return {
        ...
        has: function (name) {
          ...
          return window.KTUtilElementDataStore[element.customDataTag] &&
            window.KTUtilElementDataStore[element.customDataTag][name]
            ? true
            : false;
        },
          ...
          if (
            ...
            setTimeout(function () {
              ...
              if (Plugin.getObject("visible", column) === false) {
                ...
                if (
                  util.getBreakpoint(
                    Plugin.getObject("responsive.hidden", column)
                  ) >= screen
                ) {
                  $(tds).hide();
                } else {
                ...
                if (
                  util.getBreakpoint(
                    Plugin.getObject("responsive.visible", column)
                  ) <= screen
                ) {
                  $(tds).show();
                } else {
          ...
          top: function () {
            ...
            if (KTUtil.isInResponsiveRange("desktop")) {
              if (KTUtil.hasClass(body, "kt-header--fixed")) {
                pos =
                  pos + parseInt(KTUtil.css(KTUtil.get("kt_header"), "height"));
              }
