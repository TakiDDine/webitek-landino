...
<head>
    ...
    <base href="https://landino-test.takiddine.art/public/backend/assets/builder/">
    <!--end::Base Path -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="https://landino-test.takiddine.art/public/assets/css/custom.css" />
    ...
    <style>
        ...
        .tools-hidden.upper-builder-tools {
...
<body class="first-show">
    ...
    <style>
        ...
        aside.control-panel.custom-styling.supra.active {
    ...
    {{-- Working on it --}}
    <div class="modal fade sections-modal" id="modal-publish" tabindex="-1" role="dialog" aria-labelledby="modal-publish"
        aria-hidden="true">
    ...
    <style>
        ...
        ul.pages_list .active .edit_page {
            background: white;
            border: 0;
        }

        ul.pages_list .active .delete_page {
            background: white;
            border: 0;
        }


        .edit_page_info_wrapper {
            padding: 40px;
        }
        ...
        .edit_page_info_wrapper .edit_page_save_changes:hover {
            text-decoration: none;
            color: white;
            background: #0b73c5;
        }
...
*/
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="edit_page_info_wrapper" style='display:none;'>
                        ...
                        <textarea data-field='keywords'></textarea>
                        <label for="">Included JavaScript (Google Analitics e.t.c.)</label>
                        <textarea data-field='analitics'></textarea>
    ...
    <div class="upper-builder-tools tools-hidden">
        <div class="upper-builder-tools-right">
            ...
            <div class="tools-btn edit-sections-elements" style="
                display: flex;
                align-items: center;
                justify-content: center;">
                ...
                <label class="switch" id="edit-sections" data-target='elements'>
                    <input type="checkbox" id="mode-elements" checked>
        ...
        <div class="upper-builder-tools-left hidden" style="display: flex;">
            <div>
    ...
    <div class="supra-preloader vazir">
    ...
    <script>
        function ResetViewButton() {
            $('#viewing-desktop').removeClass('active');
            $('#viewing-mobile').removeClass('active');
        }
        $('#viewing-desktop').click(function() {
            ResetViewButton();
            $(this).addClass('active');
        });

        $('#viewing-mobile').click(function() {
            ResetViewButton();
            $(this).addClass('active');
        });
    ...
    <script>
        let is_trial = '{{ auth()->user()->company->membership_type === 'trial' }}'
    </script>
    <script src="./../builder/js/builder.min.js?ver={{ time() }}"></script>
        ...
        function loadPages() {
            ...
            pages.each(function() {
                ...
                var page_name_span = '<span data-id="' + data_id + '"  class="page_name"> ' + page_name +
                    ' </span>';
                var delete_page = '<span data-id="' + data_id +
                    '"  class="delete_page"> <img src="/public/icons/delete-page.svg" /> </span>';
                var edit_page = '<span data-id="' + data_id +
                    '"  class="edit_page"> <img src="/public/icons/edit-page.svg" /> </span>';
