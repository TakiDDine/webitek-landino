...
<head>
    ...
    <base href="https://landino.io/public/backend/assets/builder/">
    <!--end::Base Path -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="https://landino.io/public/assets/css/custom.css" />
...
*/
    ...
    <script>
        let is_trial = '{{ user()->company->membership_type === 'trial' }}'
    </script>
