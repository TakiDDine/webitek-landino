    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="custom-table">
                <ul>
                    <li>{{ _lang('Project') }}</li>
                    <li class="text-center">{{ _lang('Delete') }}</li>
                    <li class="text-center">{{ _lang('Settings') }}</li>
                    <li class="text-center">{{ _lang('Edit') }}</li>
                </ul>
                @foreach ($projects as $project)
                    <ul>
                        ...
                        <li class="text-center">
                            <a href="javascript:;" data-url="/projects/{{ $project->id }}/edit" class="edit-project">
