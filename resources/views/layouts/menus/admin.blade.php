...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('users/type/user') || Request::is('users/create')) kt-menu__item--open @endif"
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('packages') || Request::is('packages/create')) kt-menu__item--open @endif"
    data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <path
                        ...
                        id="Combined-Shape" fill="#000000" opacity="0.3"></path>
                    <polygon id="Combined-Shape-Copy" fill="#000000"
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('offline_payment/create') || Request::is('members/payment_history')) kt-menu__item--open @endif"
    data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
        ...
        <span class="kt-menu__link-icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <rect id="Rectangle-Copy-3" fill="#000000" opacity="0.3" x="11.5" y="16" width="2" height="5"
                        rx="1"></rect>
                    <path
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('languages') || Request::is('languages/create')) kt-menu__item--open @endif"
    data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('features') || Request::is('faqs') || Request::is('administration/theme_option')) kt-menu__item--open @endif"
    data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('administration/general_settings') || Request::is('email_templates') || Request::is('administration/currency_rates') || Request::is('administration/backup_database')) kt-menu__item--open @endif"
    data-ktmenu-submenu-toggle="hover" aria-haspopup="true">
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('admin/tickets')) kt-menu__item--open kt-menu__item--here @endif">
    <a href="{{ url('admin/tickets') }}" class="kt-menu__link">
        <span class="kt-menu__link-icon">
...
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('profile/edit')) kt-menu__item--open kt-menu__item--here @endif">
    <a href="{{ url('profile/edit') }}" class="kt-menu__link">
        ...
        <span class="kt-menu__link-text">{{ _lang('Profile Settings') }}</span>
    </a>
</li>
<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel @if (Request::is('profile/change_password')) kt-menu__item--open kt-menu__item--here @endif">
    <a href="{{ url('profile/change_password') }}" class="kt-menu__link">
        <span class="kt-menu__link-icon">
            <i class="flaticon2-hourglass kt-font-brand"></i>
        </span>
        <span class="kt-menu__link-text">{{ _lang('Change Password') }}</span>
    </a>
</li>
