...
<head>
    ...
    <base href="{{ asset('public/backend/assets/admin') }}">
    <!--end::Base Path -->
    <meta charset="utf-8" />
    ...
    @if (_lang('SYS_DIRECTION_DIR') == 'rtl')
        ...
        <link href="{{ asset('public/backend/admin/vendors/custom/notifications/css/ns-default.rtl.css') }}"
            rel="stylesheet" type="text/css" />
        <link href="{{ asset('public/backend/admin/vendors/custom/notifications/css/ns-style-other.rtl.css') }}"
            rel="stylesheet" type="text/css" />
