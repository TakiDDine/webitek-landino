...
<body
    ...
    @if ($user->company->membership_type == 'trial' && membership_validity() > date('Y-m-d'))
        ...
        <a href="{{ url('membership/extend') }}" class="upgrade_link">
            {{ _lang('Upgrade Now') }}
        </a>
    @endif
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        ...
                        @if (has_membership_system() == 'enabled' && $user->user_type == 'user')
                            ...
                            @endif
                            {{-- @if ($user->company->membership_type == 'trial' && membership_validity() > date('Y-m-d'))
                                <div class="alert alert-warning trial-warning" style="display: none " role="alert">
                                    <b>
                                        {{ _lang('You Are Currenly Using Trial Account !') }}&emsp;</b>

                                    <a href="{{ url('membership/extend') }}"
                                        class="btn btn-danger btn-xs">{{ _lang('Upgrade Now') }}</a>
                                    <div class="clearfix"></div>
                                </div>
                            @endif --}}
                        ...
                        <div class="row"
                            ...
                            @foreach ($templates as $template)
                                <div class="col-md-4 overflow-hidden mb-3"
                                    data-category-modal="{{ $template['category'] ?? null }}">
                                    <div
                                        ...
                                        <div class="row bg-white w-full w-100 m-0 preview-use-template">
                                            <div class="col-6">
                                                <a href="{{ route('template.preview', ['template_name' => $template['name']]) }}"
                                                    target="_blank"
                                                    class="rounded-lg btn w-100 ">{{ _lang('Preview') }}</a>
                                            </div>
                                            <div class="col-6">
                                                <a href="{{ url('/editor?template=' . $template['name']) }}"
                                                    target="_blank"
