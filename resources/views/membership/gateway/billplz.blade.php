					...
					<div class="kt-login__body">
						...
						<div class="card card-signin my-5">			
							...
							<div class="card-body" id="extend_membership">
                                ...
                                <h5 class="text-center">{{ _lang('Billplz Amount') }} : {{ g_decimal_place(convert_currency(get_option('currency','MYR'),get_option('billplz_currency','MYR'),$amount), currency(get_option('billplz_currency','MYR'))) }}</h5>
								<br>

                                <form action="{{ url('membership/billplz_payment/'.$payment_id) }}" method="post">
                                {{ csrf_field() }}
