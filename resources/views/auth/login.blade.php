                ...
                <div
                    ...
                    @if (get_option('allow_singup', 'yes') == 'yes')
                        <div class="kt-login__head">
                            <span
                                class="kt-login__signup-label">{{ _lang('Still not having an account yet?') }}</span>&nbsp;&nbsp;
                            <a href="{{ url('register/client_signup') }}"
                                class="kt-link kt-login__signup-link">{{ _lang('Sign Up') }}</a>
                        </div>
                    @endif
                    <!--begin::Body-->
