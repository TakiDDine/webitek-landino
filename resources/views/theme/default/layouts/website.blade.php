...
<head>
    ...
    <link href="{{ asset('public/theme/default/assets/css/bootstrap.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/stack-interface.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/socicon.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/lightbox.min.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/flickity.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/iconsmind.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/jquery.steps.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/theme.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/custom.css') }}" rel="stylesheet" type="text/css"
        media="all" />
    <link href="{{ asset('public/theme/default/assets/css/font-rubiklato.css') }}" rel="stylesheet" type="text/css"
        media="all" />
            ...
            <section class="cover unpad--bottom switchable switchable--switch bg--light text-center-xs">
                <div class="container">
                    <div class="row align-items-center justify-content-around">
                        ...
                        <div class="col-md-6">
                            <img alt="Image"
                                src="{{ get_array_option('home_banner_image') != '' ? asset('public/uploads/media/' . get_array_option('home_banner_image')) : theme_asset('assets/img/avatar-large-3.png') }}" />
                        </div>
                    </div>
                    <!--end of row-->
                </div>
