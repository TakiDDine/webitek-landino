...
$language["My Recent Websites"] = "My Recent Websites";
...
$language["DEMO MODE NOT ALLOWED"] = "DEMO MODE NOT ALLOWED";
$language["Demo Login Details"] = "Demo Login Details";
...
$language["Domain Settings"] = "Domain Settings";
$language["Current Domain"] = "Current Domain";
$language["Domain Type"] = "Domain Type";
$language["Sub domain"] = "Sub domain";
$language["Custom your domain"] = "Custom your domain";
$language["test.example.com"] = "test.example.com";
$language["UNFORTUNATELY IT'S NOT ALLOWED AT DEMO MODE!"] = "UNFORTUNATELY IT'S NOT ALLOWED AT DEMO MODE!";
$language["example.com"] = "example.com";
$language["You can customize subdomain"] = "You can customize subdomain";
...
$language["TTL"] = "TTL";
$language["Recaptcha Settings"] = "Recaptcha Settings";
$language["Builder"] = "Builder";
$language["Lara"] = "Lara";
$language["Novi"] = "Novi";
$language["Both"] = "Both";
$language["Google MAP Key"] = "Google MAP Key";
$language["Server Ip"] = "Server Ip";
$language["Site Key"] = "Site Key";
$language["You can assign a custom subdomains to display projects by changing it for each project from PROJECT SETTINGS"] = "You can assign a custom subdomains to display projects by changing it for each project from PROJECT SETTINGS";
$language["Edit Project Settings"] = "Edit Project Settings";
$language["Free"] = "Free";
$language["Forever"] = "Forever";
$language["Value"] = "Value";
...
$language["UNFORTUNATELY IT'S NOT ALLOWED AT DEMO MODE!"] = "UNFORTUNATELY IT'S NOT ALLOWED AT DEMO MODE!";
$language["Add records below in your domain provider's DNS settings"] = "Add records below in your domain provider's DNS settings";
$language["System Update Note"] = "If you want to take advantage of the latest update And you are in an old version, you have to download all the versions in order until you reach the update you want Example : If you are using version 6.0 and you want gold to 6.3, you have to take into account the versions between them You are now on version 6.0 You'll start upgrading to 6.1, then 6.2, and so on until you reach the version you want.";
$language["ZIP File To Import"] = "ZIP File To Import";
$language["No"] = "No";
$language["Yes"] = "Yes";
$language["Update"] = "Update";
$language["Backup Necessary"] = "It is necessary to take a backup copy of the system files and databases before make the update";