...
$language["SYSDIRECTIONDIR"] = "rtl";
$language["You"] = "أنت";
$language["No Message Found"] = "لم يتم العثور على رسالة";
$language["Classic"] = "كلاسيك";
$language["Classic Red"] = "كلاسيك ريد";
$language["Modern"] = "عصري";
$language["General"] = "عام";
$language["Custom"] = "مخصص";
...
$language["Your company account is not active !"] = "حساب شركتك غير نشط!";
$language["Your account is not active !"] = "حسابك غير فعال !";
$language["Registration Sucessfully. You May Login to your account."] = "التسجيل بنجاح. يمكنك تسجيل الدخول إلى حسابك.";
$language["Sorry, We did not find any account associated with your email !"] = "عذرا ، لم نعثر على أي حساب مرتبط ببريدك الإلكتروني!";
$language["Your Current package not support this feature. You can upgrade your package !"] = "باقتك الحالية لا تدعم هذه الميزة. يمكنك ترقية باقتك!";
$language["Sorry, Currently no business associated with your account !"] = "عذرا ، حاليا لا توجد أعمال مرتبطة بحسابك!";
$language["Illegal Operation !"] = "عملية غير قانونية!";
$language["New group created"] = "تم إنشاء مجموعة جديدة";
$language["Group updated"] = "تم تحديث المجموعة";
$language["Group Removed"] = "تمت إزالة المجموعة";
$language["left the group"] = "غادر المجموعة";
$language["You have sucessfuly left the group"] = "لقد غادرت بنجاح المجموعة";
$language["Uploaded File"] = "تحميل الملف";
$language["View Staf Information"] = "عرض معلومات الموظفين";
$language["Remove"] = "إزالة";
$language["File Uploaded Sucessfully"] = "تم تحميل الملف بنجاح";
$language["Sorry only admin or creator can remove this file !"] = "آسف فقط المسؤول أو المنشئ يمكن إزالة هذا الملف!";
$language["File Removed"] = "تمت إزالة الملف";
$language["Added Note"] = "ملاحظة مضافة";
$language["Removed Note"] = "تمت إزالة الملاحظة";
$language["Invoice Payment"] = "دفع الفاتورة";
$language["Thank You, Your payment was made sucessfully."] = "شكرًا لك ، تم سداد دفعتك بنجاح.";
...
$language["Offline Payment Made Sucessfully"] = "تم الدفع دون اتصال بنجاح";
...
$language["Name"] = "الإسم";
$language["E-Mail Address"] = "البريد الالكتروني";
$language["Confirm Password"] = "تأكيد كلمة المرور";
$language["Sign Up"] = "Sign Up";
$language["Sign In"] = "Sign In";
$language["Remember Me"] = "البقاء قيد التسجيل";
$language["Login"] = "تسجيل الدخول";
$language["Continue with Google"] = "Continue With Google";
$language["Create Account"] = "Create Account";
$language["Forgot Password?"] = "نسيت كلمة السر ؟";
$language["Reset Password"] = "إسترجاع كلمة المرور";
$language["Enter your Email"] = "ادخل البريد الالكتروني الخاص بك";
$language["Send Password Reset Link"] = "إرسال رابط استرجاع كلمة المرور";
$language["Create an Account"] = "Create An Account";
$language["Business Name"] = "إسم العمل";
$language["Select Package"] = "إختر باقة";
$language["Select Package Type"] = "إختر نوع الباقة";
$language["Monthly Pack"] = "Monthly Pack";
$language["Yearly Pack"] = "Yearly Pack";
$language["Register"] = "إنشاء حساب";
...
$language["Add New"] = "أضف جديد";
$language["List Account"] = "List Account";
$language["Currency"] = "عملة";
...
$language["Company"] = "شركة";
$language["Individual"] = "Individual";
$language["Company Name"] = "اسم الشركة";
...
$language["Total Payment"] = "المبلغ الإجمالي";
...
$language["Currency Position"] = "وضع العملة";
$language["Left"] = "Left";
$language["Right"] = "Right";
$language["Timezone"] = "وحدة زمنية";
$language["-- Select One --"] = "-- Select One --";
$language["Language"] = "Language";
$language["Date Format"] = "صيغة التاريخ";
$language["Time Format"] = "تنسيق الوقت";
...
$language["Payment History"] = "سجل الدفع";
$language["Created"] = "بتاريخ";
...
$language["Project Name"] = "اسم المشروع";
...
$language["Membership Settings"] = "إعدادات العضوية";
$language["Google Login"] = "جوجل تسجيل الدخول";
...
$language["Landing Page"] = "الصفحة المقصودة";
$language["Enable"] = "Enable";
$language["Disable"] = "Disable";
$language["Currency Converter"] = "محول العملات";
$language["Manual"] = "Manual";
$language["Fixer API"] = "Fixer API";
$language["Fixer API Key"] = "مفتاح API المثبت";
$language["GET API KEY"] = "GET API KEY";
$language["File Manager File Type Supported"] = "نوع ملف إدارة الملفات المدعومة";
$language["File Manager Max Upload Size in MB"] = "أقصى حجم لتحميل مدير الملفات بالميغابايت";
...
$language["SSL"] = "SSL";
$language["TLS"] = "TLS";
$language["Membership System"] = "نظام العضوية";
$language["Allow Sign Up"] = "السماح بالتسجيل";
$language["Email Verification"] = "تأكيد بواسطة البريد الالكتروني";
$language["Trial Period"] = "فترة النسخة التجريبية";
$language["days"] = "Days";
$language["Stripe"] = "Stripe";
$language["GOOGLE CLIENT ID"] = "معرف عميل GOOGLE";
$language["GOOGLE CLIENT SECRET"] = "سر عميل Google";
$language["GOOGLE REDIRECT URL"] = "عنوان URL الخاص بإعادة توجيه GOOGLE";
...
$language["Total Users"] = "إجمالي المستخدمين";
$language["Paid Users"] = "المستخدمون المدفوعون";
$language["Trial Users"] = "المستخدمون التجريبيون";
$language["New Registered Users"] = "المستخدمون المسجلون الجدد";
$language["Package"] = "Package";
$language["Membership"] = "عضوية";
$language["Details"] = "تفاصيل";
$language["USER ID"] = "معرف المستخدم";
$language["Recent Payments"] = "المدفوعات الأخيرة";
...
$language["Recurring Transaction"] = "معاملة متكررة";
$language["Inventory Module"] = "Inventory Module";
$language["Live Chat"] = "Live Chat";
$language["Online Payment"] = "الدفع الالكتروني";
...
$language["View Package"] = "عرض الحزمة";
$language["year"] = "Year";
$language["Features"] = "سمات";
$language["Month"] = "Month";
$language["Year"] = "Year";
...
$language["Package Details"] = "حزمة من التفاصيل";
$language["Feature"] = "ميزة";
$language["Avaialble Limit"] = "الحد المتاح";
$language["My Profile"] = "My Profile";
$language["Valid To"] = "Valid To";
$language["Create User"] = "Create User";
$language["Membership Type"] = "نوع العضوية";
$language["Trial"] = "تجربة";
...
$language["Add User"] = "إضافة مستخدم";
$language["ID"] = "ID";
$language["Id"] = "رقم";
$language["Avatar"] = "Avatar";
$language["View User"] = "عرض المستخدم";
$language["Admin Name"] = "اسم المسؤول";
$language["Admin Email"] = "البريد الإلكتروني للمسؤول";
$language["Package Valid To"] = "حزمة صالحة ل";
$language["Membersip Type"] = "نوع العضوية";
$language["Dashboard"] = "لوحة التحكم";
$language["You have"] = "You Have";
$language["new notifications"] = "New Notifications";
$language["My Subscription"] = "اشتراكي";
$language["Upgrade Subscription"] = "Upgrade Subscription";
$language["Logout"] = "تسجيل خروح";
$language["You Are Currenly Using Trial Account !"] = "أنت تستخدم حاليًا حسابًا تجريبيًا!";
$language["Upgrade Now"] = "ترقية الخطة";
$language["Renew Membership"] = "تجديد العضوية";
$language["User Management"] = "إدارة المستخدمين";
$language["Packages"] = "الخطط";
$language["Payments"] = "المدفوعات";
$language["All Language"] = "كل اللغات";
$language["Website Settings"] = "إعدادات الموقع";
$language["Software Features"] = "Software Features";
$language["Knowledge Base"] = "Knowledge Base";
$language["Theme Options"] = "Theme Options";
$language["Administration"] = "الإدارة";
...
$language["Are you sure?"] = "هل أنت متأكد؟";
$language["Once deleted, you will not be able to recover this information !"] = "بمجرد الحذف، لن تكون قادراً على استرداد هذه المعلومات! ";
$language["Yes, delete it!"] = "نعم، احذفها!"  ;
$language["Cancel"] = "إلغاء";
$language["Your project is safe!"] = "مشروعك آمن!";
$language["Copy"] = "Copy";
...
$language["Edit Project Details"] = "Edit Project Details";
...
$language["Sign up to use our features"] = "Sign up to use our features";
$language["Do you an account?"] = "هل لديك حساب؟";
$language["If you forget your password, you can reset it from here"] = "If you forget your password, you can reset it from here";
$language["Did you remember?"] = "Did you remember?";
$language["Sign in"] = "Sign in";
$language["Sign in to your control panel"] = "Sign in to your control panel";
$language["Don't have an account yet?"] = "Don't have an account yet?";
$language["OR"] = "OR";
...
$language["Project Creator"] = "Project Creator";
$language["Sections"] = "Sections";
$language["Page modals"] = "Page modals";
$language["Backend Direction"] = "اتجاه الخلفية";
$language["LTR"] = "LTR";
$language["RTL"] = "RTL";
...
$language["Package will be reset if you change the package"] = "ستتم إعادة ضبط الحزمة إذا قمت بتغيير الحزمة";
$language["Websites Limit"] = "حد مواقع الويب";
$language["My Recent Websites"] = "مواقع الويب الخاصة بي الأخيرة";
$language["Created date"] = "Created date";
...
$language["Language Direction"] = "Language Direction";
$language["Language Flag"] = "Language Flag";
$language["Website Language Dropdown"] = "قائمة لغة الموقع";
$language["Razorpay"] = "Razorpay";
$language["Key ID"] = "Key ID";
$language["Paystack"] = "Paystack";
$language["No data found"] = "No data found";
$language["Websites Linmit"] = "Websites Linmit";
$language["Websites"] = "مواقع الويب";
$language["No data availabel"] = "No data availabel";
$language["Welcome back"] = "مرحباً بعودتك";
$language["All caught up!"] = "All caught up!";
$language["No new notifications."] = "No new notifications.";
$language["Hi"] = "أهلاً";
$language["Account settings and more"] = "Account settings and more";
$language["Loading ..."] = "جاري التحميل ...";
...
$language["Home Settings"] = "Home Settings";
...
$language["Error! You must need to set max input vars = 2000 for updating translations"] = "Error! You must need to set max_input_vars = 2000 for updating translations";
$language["Still not having an account yet?"] = "Still not having an account yet?";
$language["SYS DIRECTION DIR"] = "SYS_DIRECTION_DIR";
$language["Builder"] = "باني";
$language["Lara"] = "Lara";
$language["Novi"] = "Novi";
$language["Both"] = "Both";
$language["Google MAP Key"] = "مفتاح خريطة جوجل";
$language["Novi builder"] = "Novi builder";
$language["200+ Elements based on Bootstrap 4 to create new pages."] = "200+ Elements based on Bootstrap 4 to create new pages.";
$language["Open Builder"] = "Open Builder";
$language["Lara builder"] = "Lara builder";
$language["with 400+ Elements the effort is minimized due to our new drag and drop improved builder."] = "with 400+ Elements the effort is minimized due to our new drag and drop improved builder.";
...
$language["Back to home"] = "Back to home";
$language["Completed!"] = "Completed!";
$language["Try again later..."] = "Try again later...";
$language["No content!"] = "No content!";
$language["No questions added yet!"] = "No questions added yet!";
$language["Contact Us"] = "Contact Us";
$language["send message!"] = "send message!";
$language["Please wait until the manager check your payment"] = "يرجى الانتظار حتى يتحقق المدير من الدفع الخاص بك";
$language["CIH bank"] = "CIH bank";
$language["CIH Bank"] = "CIH Bank";
$language["CIH Bank Active"] = "CIH Bank Active";
$language["Proof"] = "Proof";
$language["The payment was accepted with success"] = "The payment was accepted with success";
$language["The payment was deleted with success"] = "The payment was deleted with success";
$language["Templates"] = "القوالب";
$language["Support"] = "الدعم الفني";
$language["Preview"] = "معاينة";
$language["use template"] = "استخدام التصميم";
$language["account"] = "حـسابي";
$language["Add Project"] = " مشروع جديد ";
$language["Created at"] = "بتاريخ";
$language["Affiliate page"] = "صفحة الافيلييت";
$language["Create new ticket"] = "إنشاء تذكرة جديدة";
$language["Last updated"] = "التحديث الاخير";
$language["Owner"] = "صاحب";
$language["Ticket by"] = "أنشأت من طرف";
$language["Opened"] = "تم الفتح";
$language["Comments"] = "التعاليق";
$language["Open"] = "مفتوح";
$language["open"] = "مفتوح";
$language["Closed"] = "مغلق";
$language["closed"] = "مغلق";
$language['Sumbit Ticket'] = 'قدم التذكرة';
$language['Enter a subject for your ticket'] = 'أدخل موضوع تذكرتك';
$language['Select priority'] = 'حدد الأولوية';
$language['Select priority'] = 'حدد الأولوية';
$language['Select a category'] = 'اختر تصنيف';
$language['Description'] = 'وصف';
$language['Describe your complain in detail'] = 'قم بوصف شكواك بالتفصيل';
$language['Subject of your ticket'] = 'موضوع تذكرتك';
$language['Affiliate URL'] = 'رابط الافيليت';
$language['Update Profile'] = 'تحديث الملف';
$language['Copy the link'] = 'انسخ الرابط';
$language['My payments'] = 'مدفوعاتي';
$language['accepted'] = 'قبلت';
$language['pending'] = 'قيد الانتظار';
$language['Link'] = 'الرابط';
$language['Total visits'] = 'عدد الزيارات';
$language['Registrations'] = 'التسجيلات';
$language['Referrals'] = 'الإحالات';
$language['Package'] = 'حزمة';
$language['from'] = 'من';
$language['to'] = 'إلى';
$language['Amount'] = 'مبلغ';
$language['Renewal date'] = 'تاريخ التجديد';
$language['Full name'] = 'الإسم الكامل';
$language['Joined at'] = 'تاريخ الإنضمام';
$language['Affiliate users'] = 'المستخدمون المنتسبون';
$language['Membership Payment'] = 'دفع العضوية';
$language['Upgrade your membership to use more features'] = 'قم بترقية عضويتك لاستخدام المزيد من الميزات';
$language['Payment Gateway'] = 'طريقة الدفع';
$language['Proof'] = 'إثبات الدفع';
$language['Process'] = 'إدفع';
$language['auth.failed'] = 'معلومات الدخول غير صحيحة';
$language['Domains'] = 'النطاقات';
$language['Add new domain name'] = 'اضف اسم نطاق جديد';
$language['Domain name'] = 'إسم النطاق';
$language['Project name'] = 'إسم المشروع';
$language['invalid.domain'] = 'المرجو ادخال اسم نطاق صالح';
$language['domain.not.configured'] = 'المرجو اعداد DNS الدومين قبل اضافته.';
$language['New project'] = 'مشروع جديد';
$language['Current password'] = 'كلمة المرور الحالية';
$language['New password'] = 'كلمة المرور الجديدة';
$language['Confirm new password'] = 'تأكيد كلمة المرور الجديدة';
$language['passwords.sent'] = 'تم إرسال رابط استرجاع كلمة المرور الى صندوق الايميل الخاص بك';
$language['Reply'] = 'إجابة';
$language['Close'] = 'إغلاق';
$language['Submit'] = 'إرسال';
$language['Reply ticket'] = 'الإجابة على التذكرة';
...
$language['Domain Settings'] = 'إعدادات المجال';
$language['Current Domain'] = 'المجال الحالي';
$language['Domain Type'] = 'نوع المجال';
$language['Sub domain'] = 'المجال الفرعي';
$language['You can customize subdomain'] = 'يمكنك تخصيص المجال الفرعي';
$language['Custom your domain'] = 'تخصيص المجال الخاص بك';
$language['Update'] = 'تحديث'; 
$language['Enter your custom domain'] = 'أدخل المجال المخصص الخاص بك'; 
$language['Basic'] = 'أساسي'; 
$language['Standard'] = 'معيار'; 
$language['Language'] = 'لغة'; 
$language['Server Ip'] = 'خادم IP'; 
$language['Recaptcha Settings'] = 'إعدادات Recaptcha'; 
