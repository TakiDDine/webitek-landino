...
<html lang="{{ app()->getLocale() }}" @if(_lang('SYSDIRECTIONDIR') == 'rtl')direction="rtl" dir="rtl" style="direction: rtl"@endif >
    ...
    <head><!--begin::Base Path (base relative path for assets of this page) -->
        <base href="{{ asset('backend/assets/admin')}}"><!--end::Base Path -->
        <meta charset="utf-8" />
		...
		<!-- Others css -->
		<link rel="stylesheet" href="{{ asset('backend/assets/css/styles.css?v=1.2') }}">
		<link rel="stylesheet" href="{{ asset('backend/assets/css/responsive.css?v=1.2') }}">
        ...
        <!--begin::Global Theme Styles(used by all pages) -->
            ...
            @if (_lang('SYSDIRECTIONDIR') == 'rtl')
                ...
                <link href="{{ asset('backend/admin/vendors/custom/notifications/css/ns-default.rtl.css') }}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('backend/admin/vendors/custom/notifications/css/ns-style-other.rtl.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed"  >
     <!-- begin:: Page -->
                            ...
                            <div class="kt-widget__head">
                                ...
                                @if(Auth::user()->profile_picture != '')
                                    <div class="kt-widget__media">
                                        <img src="{{asset('uploads/profile/'.Auth::user()->profile_picture)}}" alt="image">
                                    </div>
                                @else
													...
													@foreach (Auth::user()->notifications->take(15) as $notification)
														<a href="{{ url('notification/'.$notification->id) }}" class="kt-notification__item">
															<div class="kt-notification__item-icon">
																<img src="{{ asset('uploads/profile/'.$notification->user->profile_picture) }}">
															</div>
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="kt-header__topbar-user">
										...
										@if(Auth::user()->profile_picture != '')
                                             <img alt="Pic" src="{{asset('uploads/profile/'.Auth::user()->profile_picture)}}" />
                                		@else
        ...
        <!-- App js -->
        <script src="{{ asset('backend/assets/js/scripts.js?v=1.7') }}"></script>
