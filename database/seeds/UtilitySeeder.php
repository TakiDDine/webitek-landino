...
class UtilitySeeder extends Seeder
{
	...
	public function run()
	{
		...
		DB::table('settings')->insert([
			...
			[
				'name' => 'hero_title',
				'value' => 'Start Your Business With Buildino'
			],
			[
				'name' => 'hero_sub_title',
				'value' => 'description here just add it and edite it, Start Your Business With Buildino'
			],
			[
				'name' => 'meta_keywords',
				'value' => 'drag and drop, laravel drag and drop, laravel sitebuilder, site builder, sitebuilder, website builder'
			],
			[
				'name' => 'meta_description',
				'value' => 'the same as hero_sub_title'
			],
			[
				'name' => 'language',
				'value' => 'English'
		...
		DB::table('cm_features')->insert([
			[
				'icon' => "icon icon-Life-Safer",
				'title' => "Website Builder",
				'content' => "Manage website directly from your browser",
			],
			[
				'icon' => "icon icon-Duplicate-Window",
				'title' => "Emails reminder",
				'content' => "Get remiders before your subscription ends",
			],
			[
			...
			[
				'icon' => "icon icon-Pantone",
				'title' => "Online Payments",
				'content' => "Accept Online Payments from different providers",
			],
		]);
