...
class SystemController extends Controller
{
    ...
    public function postSystemUpdate(Request $request)
    {
        ...
        $updateVersion  = floatval($this->get_string_between($originFileName,'_','z'));
        ...
        if($currentVersion ==  $updateVersion){
            ...
            return redirect()->back()->with(['message_alert' => __('view.updated_successfully_to_version') .' '.$currentVersion]);
        }else{
