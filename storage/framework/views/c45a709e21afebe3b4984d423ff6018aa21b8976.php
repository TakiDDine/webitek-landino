...
<?php $__env->startSection('head'); ?>
    ...
    <meta property="og:description"
        content="أداة لاندينو ، هي الأداة الأفضل في العالم العربي في صناعة صفحات الهبوط ، بدون حاجة لمعرفة في البرمجة والتصميم">
    <meta property="og:image" content="<?php echo e(env('APP_URL').'public/front/social-preview.png'); ?>">
    <!-- Twitter -->
    ...
    <meta property="twitter:description"
        content="أداة لاندينو ، هي الأداة الأفضل في العالم العربي في صناعة صفحات الهبوط ، بدون حاجة لمعرفة في البرمجة والتصميم">
    <meta property="twitter:image" content="<?php echo e(env('APP_URL').'public/front/social-preview.png'); ?>">
<?php $__env->stopSection(); ?>
    ...
    <div class="page page-home">
        ...
        <section class="section section--nopadd intro">
            <div class="intro-center">
                ...
                <div class="intro-mobile">
                    <img src="/public/assets/media/home/intro-mobile.svg?v1" alt="Intro illustration">
                    <a href="" target="_blank" class="btn btn--blue btn--wide"> ابدأ الآن ! مجاناً </a>
                </div>
        </section>
        <article class="section section--about section--bg blue"
            style="background-image:url('/public/assets/media/home/about/about-bg.jpg')">
            <div class="container">
                <header class="section-header">
                ...
                <div class="layout layout--about layout--3">
                    <div class="layout-col">
                        <section class="card-b">
                            <div class="card-b__icon"><img src="/public/assets/media/home/about/sell.svg" alt=""></div>
                    ...
                    <div class="layout-col">
                        <section class="card-b">
                            <div class="card-b__icon"><img src="/public/assets/media/home/about/code.svg" alt=""></div>
                            <h3 class="card-b__title">
                    ...
                    <div class="layout-col">
                        <section class="card-b">
                            <div class="card-b__icon"><img src="/public/assets/media/home/about/server.svg" alt=""></div>
                            <h3 class="card-b__title">
                    ...
                    <div class="section-footer__btnWrap">
                        ...
                        <button class="btn">
                            <svg class="icon icon--phone-call">
                                <use xlink:href="/public/assets/images/sprite.svg?v1.3.5#phone-call"></use>
                            </svg>
                            أحصل على مساعدة
                        </button>
                    </div>
        ...
        <div class="section section--nopaddbottom section--templates" style="display:none;">
            <div class="container">
                ...
                <div class="section-image">
                    <img src="/public/assets/media/home/templates.jpg?v0.0.1" alt="قالب های آماده">
                </div>
            </div>
        </div>
        <article class="section subscribe">
            <div class="container">
                ...
                <a href="" target="_blank" title="ثبت‌نام در لندیک" class="btn btn--blue btn--wide">
                    إبدأ مجاناً
                </a>
            </div>
        </article>
...
<?php echo $__env->make('theme.default.layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/takiddine-landino-test/htdocs/landino-test.takiddine.art/resources/views/theme/default/index.blade.php ENDPATH**/ ?>