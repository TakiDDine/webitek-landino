                    ...
                    <div class="col-md-3">
                        <div class="wrap__1QIKi">
                            ...
                            <div class="footer__1nPep" style="display: flex; flex-direction: column; padding: 0px 20px;">
                                ...
                                <a href="<?php echo e(route('cmi.proccess')); ?>" id="continue_payment">
                                ...
                                <div
                                    ...
                                    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
                                        <div class="kt-grid__item kt-grid__item--middle">
                                            <h3 class="kt-login__title"><?php echo e(_lang('Membership Payment')); ?>!</h3>
                                            <h4 class="kt-login__subtitle">
                                                <?php echo e(_lang('Upgrade your membership to use more features')); ?>.
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-login__body">
                                        ...
                                        <div class="kt-login__form">
                                            ...
                                            <form method="POST" class="kt-form" enctype="multipart/form-data"
                                                action="<?php echo e(url('membership/pay')); ?>">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="package" class="form-control" name="package" required>
                                                        ...
                                                        <?php echo e(create_option('packages', 'id', 'package_name', $user->company->package_id)); ?>
                                                ...
                                                <div class="form-group d-none">
                                                    ...
                                                    <select class="form-control" name="package_type" required>
                                                        ...
                                                        <option value="monthly"
                                                            <?php echo e($user->company->package_type == 'monthly' ? 'selected' : ''); ?>>
                                                            <?php echo e(_lang('Monthly Pack')); ?></option>
                                                        <option value="yearly"
                                                            <?php echo e($user->company->package_type == 'yearly' ? 'selected' : ''); ?>>
                                                            <?php echo e(_lang('Yearly Pack')); ?></option>
                                                    </select>
                                                </div>
                                                <br>

                                                <div class="form-group">
                                                    <label class="control-label"><?php echo e(_lang('Payment Gateway')); ?></label>
                                                    <select class="form-control" name="gateway" id="gateway" required>
                                                        <?php if(get_option('paypal_active') == 'Yes'): ?>
                                                            <option value="PayPal"><?php echo e(_lang('PayPal')); ?></option>
                                                        <?php endif; ?>
                                                        <?php if(get_option('stripe_active') == 'Yes'): ?>
                                                            <option value="Stripe"><?php echo e(_lang('Stripe')); ?></option>
                                                        <?php endif; ?>
                                                        <?php if(get_option('razorpay_active') == 'Yes'): ?>
                                                            <option value="Razorpay"><?php echo e(_lang('Razorpay')); ?></option>
                                                        <?php endif; ?>
                                                        <?php if(get_option('cih_active') == 'Yes'): ?>
                                                            <option value="cih"><?php echo e(_lang('CIH bank')); ?></option>
                                                        <?php endif; ?>
                                                        <?php if(get_option('paystack_active') == 'Yes'): ?>
                                                            <option value="Paystack"><?php echo e(_lang('Paystack')); ?></option>
                                                        <?php endif; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="proof-container form-group">
                                                    <br>
                                                    <label for="proof"><?php echo e(_lang('Proof')); ?></label>
                                                    <input id="proof" type="file" accept="image/png,image/jpeg,image/jpg"
                                                        class="form-control<?php echo e($errors->has('proof') ? ' is-invalid' : ''); ?>"
                                                        name="proof" autofocus>
                                                </div>

                                                <div class="kt-login__actions">
                                                    <button type="submit"
                                                        class="btn btn-primary btn-elevate kt-login__btn-primary btn-block"><?php echo e(_lang('Process')); ?></button>
                                                </div>
                                            </form>
                                            <!--end::Form-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/takiddine-landino-test/htdocs/landino-test.takiddine.ar/resources/views/membership/extend.blade.php ENDPATH**/ ?>