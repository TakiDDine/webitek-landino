...
<body class="first-show">
                ...
                <div class="modal-body">
                    ...
                    <aside class="modal-body-sections">
                        ...
                        <div class="main-section-modal add-sections-items">
                            ...
                            <?php $__currentLoopData = $data['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $node['sections']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="section__item__li" data-section-group="<?php echo e($key); ?>">
                                        <a href="#" class="section__item" data-section-name="<?php echo e($section->name); ?>">
                                            <img src="<?php echo e($section->preview); ?>" alt="">
                                        </a>
                                    </li>
    ...
    <div class="upper-builder-tools tools-hidden">
        ...
        <div class="upper-builder-tools-left" style="display: flex;">
            ...
            <div class="publish _disabled">
                <a href="javascript:;" id="publish-modal-open" >
    ...
    <div class="wrap-iframe d-flex justify-content-center align-items-center">
        <div class="wrap viewing-desctop">
            ...
            <iframe id="main" src="<?php echo e(url('updateproject/builder')); ?>/<?php echo e($id); ?>"></iframe>
    ...
    <script>
        var demoMode = <?php if(isset($demo) && $demo == true): ?> true <?php else: ?> 'no' <?php endif; ?>;
        ...
        var project_id = '<?php echo e($id); ?>';
        var project_file = '<?php echo e($projectfile); ?>';
        var project_file_name = '';
        var user_id = <?php echo e(auth()->user()->id); ?>

        var subdomain = '<?php echo e(optional($project)->subdomain); ?>'
        var edit_mode = true
        var _save = false
    </script>
...
<?php /**PATH /home/takiddine-landino-test/htdocs/landino-test.takiddine.ar/resources/views/backend/accounting/project/editlara.blade.php ENDPATH**/ ?>