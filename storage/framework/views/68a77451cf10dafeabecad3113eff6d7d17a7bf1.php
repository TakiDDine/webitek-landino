...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('build/css/intlTelInput.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/main.css?v1.3.5')); ?>">
</head>
...
<body>
    ...
    <script src="<?php echo e(asset('assets/js/script.js?v1.3.5')); ?>"></script>

    <script src="<?php echo e(asset('build/js/intlTelInput-jquery.min.js')); ?>"></script>
    <?php echo $__env->yieldContent('js'); ?>
</body>


</html>
<?php /**PATH /home/takiddine-landino-test/htdocs/landino-test.takiddine.ar/resources/views/website/layout.blade.php ENDPATH**/ ?>